...
for i, idp in enumerate(mm_idp):
    ...
    idp_df.to_csv(f"../../data/xxy_{idp}.csv")
...
scd_effect_withTTV_df.to_csv("../../data/xxy_scd_bcoef_effect_withTTV.csv")
scd_effect_withoutTTV_df.to_csv("../../data/xxy_scd_bcoef_effect_withoutTTV.csv")